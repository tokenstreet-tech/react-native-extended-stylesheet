...
describe('value', () => {
    it('should keep values without transform', () => {
    ...
    it('should calc simple operations', () => {
    ...
    it('should substitute vars/rems/percents in operations', () => {
    ...
    it('should not calc operations for non-operation values', () => {
